...
function makeTimer() {
			...
			var endTime = new Date("22 December 2018 23:59:59 GMT+01:00");			
			...
			$("#days").html(days + "<span><b>Jours</b></span>");
			$("#hours").html(hours + "<span><b>Heures</b></span>");
			$("#minutes").html(minutes + "<span><b>Minutes</b></span>");
			$("#seconds").html(seconds + "<span><b>Secs</b></span>");		
